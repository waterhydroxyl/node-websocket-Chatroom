...
class CommentController {
  async create(ctx, next) {
    const { name, picUrl = 'www', content, fileType, Type } = ctx.request.body;
    console.log(name, picUrl, content, Type);
    const result = await service.create(name, picUrl, content, fileType, Type);
    ctx.body = result;
  }
